...
export function About(){
  return(
      ...
      <div className={styles.content}>
        ...
        <br />
        <p>aqui é um espacinho especial no famoso world way web que separei para colocar meu conhecimento em jogo e mostrar tudo o que vim estudando durante minha jornada de desenvolvedor </p>
        <br />
